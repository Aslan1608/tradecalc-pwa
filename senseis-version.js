...
function loadListSemantics(){loadScript('focus-list-semantics','./focus-list-semantics-v2.js?v=2',loadExtras)}
...
function loadMenu(){loadScript('focus-menu','./focus-menu.js?v=2',loadDecision)}
