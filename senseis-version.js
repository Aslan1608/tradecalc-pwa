...
window.SENSEIS_BUILD_LABEL='Focus Explainability';
...
function loadExplain(){if(document.querySelector('script[data-senseis-focus-explain]'))return;const script=document.createElement('script');script.dataset.senseisFocusExplain='1';script.src='./focus-explainability.js?v=1';document.head.appendChild(script)}
