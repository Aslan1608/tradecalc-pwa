...
window.SENSEIS_BUILD_LABEL='Focus Menu';
...
function loadMenu(){if(document.querySelector('script[data-senseis-focus-menu]'))return;const script=document.createElement('script');script.dataset.senseisFocusMenu='1';script.src='./focus-menu.js?v=1';document.head.appendChild(script)}
