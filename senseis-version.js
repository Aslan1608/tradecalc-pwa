...
window.SENSEIS_BUILD_LABEL='Focus Universe Transparency';
...
function loadOverview(){if(document.querySelector('script[data-senseis-focus-overview]'))return;const script=document.createElement('script');script.dataset.senseisFocusOverview='1';script.src='./focus-list-v2.js?v=1';document.head.appendChild(script)}
function loadExplain(){const existing=document.querySelector('script[data-senseis-focus-explain]');if(existing){loadOverview();return}const script=document.createElement('script');script.dataset.senseisFocusExplain='1';script.src='./focus-explainability.js?v=1';script.onload=loadOverview;script.onerror=loadOverview;document.head.appendChild(script)}
